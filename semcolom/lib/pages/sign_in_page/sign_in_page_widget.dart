                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        width: 320.0,
                        child: TextFormField(
                          controller: _model.signInEmailOrUserNameArController,
                          focusNode: _model.signInEmailOrUserNameArFocusNode,
                          autofocus: true,
                          obscureText: false,
                    ...
                    Padding(
                      ...
                      child: Container(
                        width: 320.0,
                        child: TextFormField(
                          controller: _model.signInePasswordArController,
                          focusNode: _model.signInePasswordArFocusNode,
                          autofocus: true,
                          textCapitalization: TextCapitalization.none,
                          obscureText: !_model.signInePasswordArVisibility,
                          decoration: InputDecoration(
                            labelStyle: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                            ...
                            suffixIcon: InkWell(
                              onTap: () => setState(
                                () => _model.signInePasswordArVisibility =
                                    !_model.signInePasswordArVisibility,
                              ),
                          ...
                          validator: _model.signInePasswordArControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        ...
                        final user = await authManager.signInWithEmail(
                          context,
                          _model.signInEmailOrUserNameArController.text,
                          _model.signInePasswordArController.text,
                        );
                        if (user == null) {
                          return;
                        }
