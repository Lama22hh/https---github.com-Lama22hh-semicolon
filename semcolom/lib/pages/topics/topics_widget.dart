              ...
              children: [
                StreamBuilder<List<TopicRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<TopicRecord> listViewTopicRecordList = snapshot.data!;
                    return ListView.builder(
                      padding: EdgeInsets.zero,
                      shrinkWrap: true,
                      scrollDirection: Axis.vertical,
                      itemCount: listViewTopicRecordList.length,
                      itemBuilder: (context, listViewIndex) {
                        final listViewTopicRecord =
                            listViewTopicRecordList[listViewIndex];
                        return Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              16.0, 14.0, 16.0, 10.0),
                          child: StreamBuilder<List<PostsRecord>>(
                            stream: queryPostsRecord(
                              parent: listViewTopicRecord.reference,
                            ),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              if (!snapshot.hasData) {
