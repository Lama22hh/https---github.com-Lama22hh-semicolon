...
class AddTopicWidget extends StatefulWidget {
  ...
  @override
  _AddTopicWidgetState createState() => _AddTopicWidgetState();
}
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          await TopicRecord.collection
                              .doc()
                              .set(createTopicRecordData(
                                category: _model.textController2.text,
                                lastPost: getCurrentTimestamp,
